    ...
    <div class="border-card">
      <header class="view-header">
        <div class="header-container">
            ...
            <el-col :span="13">
              <el-row :gutter="10">
                ...
                <el-col :span="7" style="display:flex;align-items: center;">
                  <el-select v-model="isNull" clearable>
                    <el-option :value="0" label="金融机构" />
                    <el-option :value="0" label="融资主体" />
                    <el-option :value="0" label="债务名称" />
                  </el-select>
                  ：
                ...
                <el-col :span="1">
                  <el-button type="primary" :icon="isShow?'el-icon-menu':'el-icon-s-grid'" @click="()=>isShow=!isShow">
                    {{isShow?'收起':'展开'}}</el-button>
                </el-col>
              </el-row>
            </el-col>
            <el-col :span="11" class="handle-btn">
              <ShangChuan />
              <el-button type="primary" icon="el-icon-download" @click="goAdd">模板下载</el-button>
              <el-button type="primary" icon="el-icon-document-checked" @click="goAdd">导出</el-button>
          ...
          <el-row style="margin-top:10px" v-if="isShow" :gutter="10">
            <el-col :span="24">
              <el-col :span="2">
                <el-select clearable v-model="isNull" placeholder="是否结清">
      ...
      <section class="table-container view-section">
        <el-table :header-cell-style="{background:'#F0FAFF',color:'#787878'}" border stripe v-loading="loading"
          ...
          <el-table-column label="档案号" prop="pname" align="left" />
          <el-table-column label="地号" prop="pname" align="left" />
          <el-table-column label="地块名称" prop="pname" align="left" />
          <el-table-column label="产权坐落位置" prop="pname" align="left" />
          <el-table-column label="土地证(或不动产证编号)" prop="pname" align="left" />
          <el-table-column label="面积㎡" prop="pname" align="left" width="110" />
          <el-table-column label="土地出让金额(万元)" prop="pname" align="left" width="120" />
          <el-table-column label="土地用途(地类)" prop="pname" align="left" width="120" />
          <el-table-column label="抵押用于融资项目名称" prop="pname" align="left" width="120" />
          <el-table-column label="抵押金融机构" prop="pname" align="left" />
          <el-table-column label="抵押期限(月)" prop="pname" align="left" width="110" />
          <el-table-column label="归属公司" prop="pname" align="left" />
